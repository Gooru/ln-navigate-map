...
CREATE UNIQUE INDEX st_ucculc_idx
    ON suggestions_tracker (user_id, class_id, course_id, unit_id, lesson_id, collection_id)
    where class_id is not null and collection_id is not null;


CREATE UNIQUE INDEX st_uculcc_null_class_idx
    ON suggestions_tracker (user_id, course_id, unit_id, lesson_id, collection_id)
