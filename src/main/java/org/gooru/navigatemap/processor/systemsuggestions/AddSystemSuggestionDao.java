...
interface AddSystemSuggestionDao {
    ...
    @SqlQuery("select id, ctx_user_id, ctx_course_id, ctx_unit_id, ctx_lesson_id, ctx_class_id, ctx_collection_id, "
                  ...
                  + ":suggestionType;")
    AlternatePath findUserPathForRoute0WithClass(@BindBean AddSystemSuggestionCommand.AddSystemSuggestionsBean bean);
    ...
    @SqlQuery("select id, ctx_user_id, ctx_course_id, ctx_unit_id, ctx_lesson_id, ctx_class_id, ctx_collection_id, "
                  ...
                  + ":suggestionType;")
    AlternatePath findUserPathForRoute0WithoutClass(@BindBean AddSystemSuggestionCommand.AddSystemSuggestionsBean bean);
