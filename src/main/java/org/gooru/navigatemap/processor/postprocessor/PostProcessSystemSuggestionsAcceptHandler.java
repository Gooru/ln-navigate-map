...
class PostProcessSystemSuggestionsAcceptHandler implements PostProcessorHandler {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(PostProcessSystemSuggestionsAcceptHandler.class);
  ...
  private void handleInClass() {
    if (command.getCollectionId() == null) {
      ...
      suggestionTrackerModel = getPostProcessorDao()
          .fetchSystemSuggestionInClassAtCollection(command);
    }
  }
  ...
  private void handleForIL() {
    if (command.getCollectionId() == null) {
      ...
      suggestionTrackerModel = getPostProcessorDao()
          .fetchSystemSuggestionForILAtCollection(command);
    }
  }
