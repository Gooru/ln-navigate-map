 ...
 */
class SuggestionsTrackerModelsBuilderForTeacherSuggestion implements
    SuggestionTrackerModelsBuilder {
  ...
  private SuggestionTrackerModel buildSuggestionTrackerModel(UUID userId) {
    ...
    model.setSuggestedContentType(
        SuggestionTrackerTypes.SuggestedContentType.builder(command.getSuggestedContentType())
            .getName());
