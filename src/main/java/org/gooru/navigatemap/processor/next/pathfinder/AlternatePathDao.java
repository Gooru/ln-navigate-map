...
public interface AlternatePathDao {
  ...
  AlternatePath findAlternatePathByPathIdAndUserForIL(@Bind("pathId") Long pathId,
  ...
  @SqlQuery(
      "select id, ctx_user_id, ctx_class_id, ctx_course_id, ctx_unit_id, ctx_lesson_id, ctx_collection_id, "
          ...
          + ":classId::uuid")
  AlternatePath findAlternatePathByPathIdAndUserInClass(@Bind("pathId") Long pathId,
      @Bind("user") String user,
  ...
  List<AlternatePath> findNextTeacherPathsForSpecifiedContext(
      @BindBean ContentAddress contentAddress,
      @Bind("user") String user, @Bind("classId") String classId);
  ...
  @SqlQuery(
      "select id, ctx_user_id, ctx_class_id, ctx_course_id, ctx_unit_id, ctx_lesson_id, ctx_collection_id, "
          ...
          + "user_navigation_paths where ctx_user_id = :user::uuid and ctx_class_id = :classId::uuid "
          + " and ctx_course_id = :course::uuid and ctx_unit_id = :unit::uuid and ctx_lesson_id = "
          + ":lesson::uuid and ctx_collection_id = :collection::uuid and suggestion_type = 'system' and "
          + "suggested_content_type = 'collection' and id > :currentPathId order by id asc ")
  List<AlternatePath> findNextSystemPathOfCollectionInClass(@BindBean ContentAddress contentAddress,
      @Bind("user") String user, @Bind("classId") String classId,
      @Bind("currentPathId") Long currentPathId);

  @Mapper(AlternatePathMapper.class)
  @SqlQuery(
      "select id, ctx_user_id, ctx_class_id, ctx_course_id, ctx_unit_id, ctx_lesson_id, ctx_collection_id, "
          + "suggestion_type, suggested_content_id, suggested_content_type, suggested_content_subtype from "
          + "user_navigation_paths where ctx_user_id = :user::uuid and ctx_class_id is null "
          + " and ctx_course_id = :course::uuid and ctx_unit_id = :unit::uuid and ctx_lesson_id = "
          + ":lesson::uuid and ctx_collection_id = :collection::uuid and suggestion_type = 'system' and "
          + "suggested_content_type = 'collection' and id > :currentPathId order by id asc ")
  List<AlternatePath> findNextSystemPathOfCollectionForIL(@BindBean ContentAddress contentAddress,
      @Bind("user") String user, @Bind("currentPathId") Long currentPathId);
