...
abstract class ContentFinderForMilestoneDao {
  ...
  abstract List<String> findNextMilestonesInCourse(@Bind("courseId") String courseId,
      @Bind("fwCode") String fwCode, @Bind("milestoneId") String milestoneId);
  ...
  abstract List<ContentAddress> findNextCollectionsInCL(@Bind("courseId") String courseId,
      @Bind("unitId") String unitId, @Bind("lessonId") String lessonId,
  ...
  @Mapper(ContentAddressMapper.class)
  abstract List<ContentAddress> findCollectionsInCL(@Bind("courseId") String courseId,
      @Bind("unitId") String unitId, @Bind("lessonId") String lessonId);
