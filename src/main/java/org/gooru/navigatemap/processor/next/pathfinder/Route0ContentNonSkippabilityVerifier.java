 ...
 */
class Route0ContentNonSkippabilityVerifier implements ContentVerifier {

    private final String user;
    private final ContentFinderDao finderDao;
    private final UserCompetencyCompletionDao userCompetencyCompletionDao;

    private Route0ContentNonSkippabilityVerifier(DBI dbi, String user) {
    ...
    static Route0ContentNonSkippabilityVerifier build(DBI dbi, String user) {
        return new Route0ContentNonSkippabilityVerifier(dbi, user);
    }
