...
public final class PostProcessorPayloadCreator {
  ...
  /**
   * Remove the data specific to content section as it is huge and create another JsonObject to do
   * postprocessing
   *
   ...
   */
  public static PostProcessorPayloadCreator buildFromNextApiResponse(String user,
    ...
    JsonObject postProcessorResponse = new JsonObject().put(Constants.Response.RESP_CONTEXT,
        responseJson.getJsonObject(Constants.Message.MSG_HTTP_BODY)
            .getJsonObject(Constants.Response.RESP_CONTEXT))
        .put(Constants.Response.RESP_SUGGESTIONS,
            responseJson.getJsonObject(Constants.Message.MSG_HTTP_BODY)
