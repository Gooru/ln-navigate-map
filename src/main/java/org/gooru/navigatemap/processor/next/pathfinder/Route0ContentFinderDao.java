...
interface Route0ContentFinderDao {
    ...
    @SqlQuery("select id, user_route0_content_id, unit_id, unit_title, unit_sequence, lesson_id, lesson_title, "
                  ...
                  + "user_route0_content_details where user_route0_content_id = (select id from user_route0_content "
    ...
    @SqlQuery("select id, user_route0_content_id, unit_id, unit_title, unit_sequence, lesson_id, lesson_title, "
                  ...
                  + "route0_sequence asc")
    List<UserRoute0ContentDetailModel> fetchAllContentsFromRoute0(@BindBean Route0ContentFinderContext context);
