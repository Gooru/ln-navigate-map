...
interface Route0ContentFinderDao {
    ...
    @SqlQuery("select exists (select 1 from user_route0_content_detail where id = :pathId and unit_id = :unitId and "
    ...
    @SqlQuery("select id, user_route0_content_id, unit_id, unit_title, unit_sequence, lesson_id, lesson_title, "
                  ...
                  + "route0_sequence asc")
    List<UserRoute0ContentDetailModel> fetchNextContentsFromRoute0ForIL(@BindBean Route0ContentFinderContext context);
    ...
    @SqlQuery("select id, user_route0_content_id, unit_id, unit_title, unit_sequence, lesson_id, lesson_title, "
                  ...
                  + "(select route0_sequence from user_route0_content_detail where id = :pathId) order by "
                  + "route0_sequence asc")
    List<UserRoute0ContentDetailModel> fetchNextContentsFromRoute0InClass(@BindBean Route0ContentFinderContext context);
    ...
    @SqlQuery("select id, user_route0_content_id, unit_id, unit_title, unit_sequence, lesson_id, lesson_title, "
                  ...
                  + "route0_sequence asc")
    UserRoute0ContentDetailModel fetchSpecifiedItemFromRoute0ForIL(@BindBean Route0ContentFinderContext context);
    ...
    UserRoute0ContentDetailModel fetchSpecifiedItemFromRoute0InClass(@BindBean Route0ContentFinderContext context);
    ...
    UserRoute0ContentDetailModel fetchFirstItemFromLessonForRoute0ForIL(@BindBean Route0ContentFinderContext context);
    ...
    @SqlQuery("select id, user_route0_content_id, unit_id, unit_title, unit_sequence, lesson_id, lesson_title, "
                  ...
                  + "and lesson_id = :lessonId order by route0_sequence asc limit 1")
    UserRoute0ContentDetailModel fetchFirstItemFromLessonForRoute0InClass(@BindBean Route0ContentFinderContext context);
    ...
    @SqlQuery("select id, user_route0_content_id, unit_id, unit_title, unit_sequence, lesson_id, lesson_title, "
                  ...
                  + "route0_sequence asc")
    List<UserRoute0ContentDetailModel> fetchAllContentsFromRoute0ForIL(@BindBean Route0ContentFinderContext context);
    ...
    @SqlQuery("select id, user_route0_content_id, unit_id, unit_title, unit_sequence, lesson_id, lesson_title, "
                  ...
                  + "route0_sequence asc")
    List<UserRoute0ContentDetailModel> fetchAllContentsFromRoute0InClass(@BindBean Route0ContentFinderContext context);

    @SqlQuery("select exists (select 1 from user_route0_content where user_id = :userId and course_id = :courseId and"
                  + " class_id is null and status = 'accepted')")
    boolean route0ExistsAndAcceptedByUserForIL(@Bind("userId") UUID userId, @Bind("courseId") UUID courseId);

    @SqlQuery("select exists (select 1 from user_route0_content where user_id = :userId and course_id = :courseId and"
                  + " class_id = :classId and status = 'accepted')")
    boolean route0ExistsAndAcceptedByUserInClass(@Bind("userId") UUID userId, @Bind("courseId") UUID courseId,
