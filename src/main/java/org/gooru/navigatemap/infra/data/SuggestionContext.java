...
public final class SuggestionContext {
  ...
  public static SuggestionContext buildSuggestionContextWithAssessments(
      List<String> suggestedAssessments) {
  ...
  public static SuggestionContext buildSuggestionContextWithCollections(
  ...
  public static SuggestionContext buildSuggestionContextWithResources(
