...
public final class NavigateProcessorContext {
  ...
  public boolean suggestionsApplicable() {
    if (suggestionsFlagInitialized == null) {
      suggestionsFlagInitialized = new SuggestionsApplicabilityVerifier(this)
          .areSuggestionApplicable();
    }
  ...
  public ContentAddress getCurrentContentAddress() {
    if (!currentAddressSet) {
      ...
      currentContentAddress
          .setCollection(Objects.toString(requestContext().getCollectionId(), null));
      currentContentAddress
          .setCurrentItem(Objects.toString(requestContext().getCurrentItemId(), null));
  ...
  public FinderContext createFinderContext() {
    return new FinderContext(requestContext().getState(), requestContext(),
        getCurrentContentAddress(),
